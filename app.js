...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 // Refactored oject list function
...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 // Refactored sum and product function

 let newSumAndProduct = (a, b) => {
    let newSumm = a + b;
    let newProduct = a * b;
    return [newSumm, newProduct];
 };
 console.log(newSumAndProduct(4, 5));
...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 // Refactored message function

 let newMessage = (newName) => {
    return `Hello, ${newName}!`;
 };

 console.log(newMessage('Vaidas'));
...
// 1. When joe.scope() is invoked, "this" refers to the "joe" object. This is because 
// "scope" is a method on the "Student" prototype, and when we call a method on an object,
// "this" is set to the object the method is called on.

// 2. When joe.scopeArrow() is invoked, "this" does not refer to the "joe" object. This is 
// because of the nature of arrow functions. "this" would be set to the context in which 
// the arrow function was defined, which is the global scope in this case.

// 3. The reason for this difference is that arrow functions do not create their own "this" 
// context. Instead, they capture the "this" value from the enclosing context at the time 
// they are created. Traditional functions create a new "this" context 
